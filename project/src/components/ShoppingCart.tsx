                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="w-6 h-6 bg-slate-700 hover:bg-slate-600 text-white rounded-full flex items-center justify-center transition-colors duration-200"
                          >
                            <Minus size={12} />
                          </button>
                          ...
                          <button
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                            className="w-6 h-6 bg-violet-600 hover:bg-violet-700 text-white rounded-full flex items-center justify-center transition-colors duration-200"
                          >
                            <Plus size={12} />
                          </button>
                        </div>
        ...
        {state.items.length > 0 && (
          <div className="border-t border-slate-700 p-6 space-y-4">
            ...
            <div className="space-y-3">
              <button className="w-full px-6 py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold rounded-full hover:from-violet-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                Checkout
              </button>
              <button
                onClick={clearCart}
